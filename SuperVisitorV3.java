...
/* change outputList to IRList
    change return3AC, findIdNode, exprstack, functionRecord */
...
public class SuperVisitor extends LexBaseVisitor<Node> {
	...
	protected List<Integer> trackLinkNum = new ArrayList<Integer>();
...
/*--------------------lou modify-----------------*/  
	...
	public String createTemp() {
		tempIndex += 1;
		((ArrayList)tempMap.get(functionRecord)).add("$T"+ Integer.toString(tempIndex));
